...
<div class="content">
    ...
    <p class="text-center">This project is creating for you. So you can get the latest news</p>
    <p class="text-center p-3 m-2">senectus et netus et malesuada fames ac turpis egestas integer eget aliquet nibh praesent tristique magna sit
